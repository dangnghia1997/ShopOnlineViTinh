<form id='form_add_cate' action="test_upload" method="post" enctype="multipart/form-data">
      ...
      <div class="modal-content edit-ajax">
        ...
        <div class="modal-body">
            ...
            <div class="border-top" style="margin: auto">
               <div class="card-body">
                   <input type="submit" class="btn btn-success" value="Thêm" name="btn_them"></input>
